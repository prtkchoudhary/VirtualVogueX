  ...
  render() {
    return (
      <div>
        ...
        <h1 style={{marginTop: "5%", fontSize: "6rem"}}>Welcome to <span style={{color: "#edca0d", fontWeight: "bold"}}>VirtualVogue</span></h1>
        <h1 style={{marginTop: "2%", fontSize: "2.7rem"}}>VirtualVogue (pronounced <b>fashion</b>) stands for "Fashionable, Sustainable, Haute & Nouveau" <br />
