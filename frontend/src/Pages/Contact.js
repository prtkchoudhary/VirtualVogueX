  ...
  render() {
    return (
      <div className="container" style={{marginBottom: "5%"}}>
        ...
        Please write us at contact@VV.com with any questions, concerns, or technical problems.
        ...
        You can contact VV Customer Assistance for COVID at: cvdcustomercare@VirtualVogue.com. A sales representative will respond as soon as possible.
        <br/><br/><br/>

        <h2>We hope you enjoy VirtualVogue</h2> 
