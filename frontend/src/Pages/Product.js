...
class Product extends Component {
  ...
  fetchApiToken = async () => {
    try {
      const response = await fetch("https://54.205.90.24:5000/api/token"); // Adjust URL as needed
  ...
  fetchProductData = () => {
    ...
    fetch(`https://54.205.90.24:5000/getproductbyid/${prod_id}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  handleSubmit = async (e) => {
    ...
    Axios({
      ...
      url: "https://54.205.90.24:5000/addreview",
    }).then((res) => {
      console.log(res);
  ...
  render() {
    const addToCart = (cartProduct) => {
      Axios({
        ...
        withCredentials: true,
        url: "https://54.205.90.24:5000/addtocart",
      }).then((res) => {
        console.log(res);
        alert(res.data);
      });
    ...
    const addToWishlist = (cartProduct) => {
      Axios({
        ...
        withCredentials: true,
        url: "https://54.205.90.24:5000/addtowishlist",
      }).then((res) => {
        console.log(res);
        alert(res.data);
      });
